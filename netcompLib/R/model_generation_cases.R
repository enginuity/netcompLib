...
## TODO: [Obselete] 2015.05.01 -- none of these functions are used in anything except for model_generation.R (EXCEPT for starter_tree, but that also exists elsewhere...)
