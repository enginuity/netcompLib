...
computePval.NetworkStructSBM = function(NetS, adja1, adja2, Nobs = 1, pl, mode = "default", model_type = "default", verbose = TRUE, vbset = c(1,0,0)) {
  ...
  if (model_type == "default") {
    ...
    ## TODO: Remove this case eventually. 
  } else {
